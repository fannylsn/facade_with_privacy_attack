...
config_file=config_FLICKR_deprl.ini
...
prefix_dir=flickr_deprl_configs_$(date '+%Y-%m-%dT%H:%M')
...
do
    ...
    do
        ...
        log_dir_from_decpy=eval/data/$prefix_dir/config$config/lr_${lr}_$(date '+%Y-%m-%dT%H:%M')
