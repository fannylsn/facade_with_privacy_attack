...
procs_per_machine=16 # =32/4
iterations=1200


prefix_dir=debug_idca_fair_mod_$(date '+%Y-%m-%dT%H:%M')
...
do
    ...
    log_dir_from_decpy=eval/data/$prefix_dir/lam_${lambda}_$(date '+%Y-%m-%dT%H:%M')
