...
script_path=./tutorial/IDCAwithoutPS # Path to the folder where the run_IDCA.sh is located
...
log_dir=$run_path/$(date '+%Y-%m-%dT%H:%M')_idca_no_ps/machine$m # in the eval folder
mkdir -p $log_dir
