...
# seeds=(21 27 2127) # A
seeds=(1204 0412) # B
# seeds=(77377 66798 0903332 776823)
lr=0.3
...
do
    ...
    do
        ...
        $python_bin/crudini --set $run_path/$config_file NODE graph_seed $seed

        echo lr $lr

        log_dir_from_decpy=eval/data/$prefix_dir/config_$config/$(date '+%Y-%m-%dT%H:%M')
